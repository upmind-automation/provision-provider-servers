...
3. Clone your fork into the `local/` directory where you have installed the provision workbench and run `composer install upmind/provision-provider-servers:@dev` - it will install from your fork in local/
